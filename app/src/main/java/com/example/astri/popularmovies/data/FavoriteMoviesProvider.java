...
public class FavoriteMoviesProvider  extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            case MOVIES:
                rowsDeleted = db.delete(FavoriteMoviesContract.MoviesEntry.TABLE_NAME, s,
                        strings);
                break;
            case VIDEOS:
                rowsDeleted = db.delete(FavoriteMoviesContract.VideosEntry.TABLE_NAME, s,
                        strings);
                break;
            case REVIEWS:
                rowsDeleted = db.delete(FavoriteMoviesContract.ReviewsEntry.TABLE_NAME, s,
                        strings);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            case MOVIES:
                rowsUpdated = db.update(FavoriteMoviesContract.MoviesEntry.TABLE_NAME, contentValues,s,strings);
                break;

            case VIDEOS:
                rowsUpdated = db.update(FavoriteMoviesContract.VideosEntry.TABLE_NAME, contentValues,s,strings);
                break;

            case REVIEWS:
                rowsUpdated = db.update(FavoriteMoviesContract.ReviewsEntry.TABLE_NAME, contentValues,s, strings);
                break;
